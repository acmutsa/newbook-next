			...
			<div className="mx-auto w-screen max-w-7xl px-5 pt-20 text-utsa-blue">
				...
				<div className="grid grid-cols-3 grid-rows-2 gap-6">
					<p className="col-span-3 col-start-1 row-start-1 md:col-span-1">
						NewBook was a platform designed by UTSA students, for
						UTSA students!<br></br>
						<br></br> Our project goal was to make the process of
						exploring and evaluating UTSA courses, faculty, and
						advisors simple, insightful, and student focused.
						Whether you’re planning your schedule or seeking advice,
						NewBook helps you make informed decisions with real
						reviews and ratings from your peers.
					</p>
					<p className="col-span-3 row-start-2 md:col-span-1">
						This project was created in Fall 2024 by members of
						UTSA’s Association for Computing Machinery (ACM). As a
						...
						<br></br>
						<b>
							Together, we’re building a stronger, more informed
							UTSA community.
						</b>
					</p>
					<Image
				...
				<div className="">
					<Accordion type="single" collapsible>
						...
						<AccordionItem value="item-3">
							<AccordionTrigger>
								Is my information anonymous when I submit a
								review?
							</AccordionTrigger>
							<AccordionContent>
								Yes, all submissions are anonymous to ensure
								students feel comfortable providing honest
								feedback.
							</AccordionContent>
						</AccordionItem>
